(function ($) {
  ...
  $.Window.prototype = {
    init: function () {
      ...
      templateData.title = $.JsonLd.getTextValue(_this.manifest.getLabel());
    ...
    removeBookView: function () {
      ...
      if (this.manifest.getManifest().getSequenceByIndex(0).getViewingHint().toString() !== Manifesto.ViewingHint.PAGED) {
    ...
    bindAnnotationEvents: function () {
      ...
      _this.eventEmitter.subscribe('annotationDeleted.' + _this.id, function (event, annoId) {
        ...
        _this.endpoint.deleteAnnotation(annoId, function () {
              _this.annotationsList = jQuery.grep(_this.annotationsList, function (e) {
                return e['@id'] !== annoId;
              });
    ...
    toggleFocus: function (focusState, imageMode) {
      ...
      _this.eventEmitter.publish("windowUpdated", {
        ...
        loadedManifest: _this.manifest.getId(),
    ...
    toggleScrollView: function (canvasID) {
      ...
      if (this.focusModules.ScrollView === null) {
        ...
        this.focusModules.ScrollView = new $.ScrollView({
          ...
          imagesList: this.imagesList,
          thumbInfo: {
            thumbsHeight: Math.floor(containerHeight * this.scrollImageRatio),
            listingCssCls: 'scroll-listing-thumbs',
            thumbnailCls: 'scroll-view'
          }
        });
      } else {
    ...
    updateFocusImages: function (imageList) {
      ...
      if (this.bottomPanel) {
        this.bottomPanel.updateFocusImages(this.focusImages);
      }
    },
