...
(function ($) {
  ...
  $.Layer.prototype = {
    init: function () {
      ...
      this.eventEmitter.subscribe(_this.windowId + ':layers-transform-resource-enabled', function (event, resource) {
      ...
      this.eventEmitter.subscribe(_this.windowId + ':layers-transform-resource-disabled', function (event, resource) {
        if (_this.imageResource.getId() === resource.getId()) {
