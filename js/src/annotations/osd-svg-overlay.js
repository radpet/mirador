      ...
      var image = this.initialImageStrategy.getTiledImages().done(function (imageResources) {
        ...
        if (_this.paperScope && _this.paperScope.view && tiledImage) {
          ...
          for (var j = 0; j < allItems.length; j++) {
            ...
            allItems[j].strokeWidth = allItems[j].data.currentStrokeValue / _this.paperScope.view.zoom;
            if (allItems[j].style) {
              allItems[j].style.strokeWidth = allItems[j].data.currentStrokeValue / _this.paperScope.view.zoom;
            }
          }
        }
